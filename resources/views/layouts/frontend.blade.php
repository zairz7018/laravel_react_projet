...
<html lang="zxx">
  <head>
    <meta charset="UTF-8" />
    <meta name="description" content="khaddar.ma" />
    <meta name="keywords" content="Ogani, unica, creative, html" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta http-equiv="X-UA-Compatible" content="ie=edge" />
    <title>khaddar.ma</title>
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="#"><img src="{{ asset('frontend/img/logo2.jpg') }}" alt="" /></a>
      </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="header__top__left">
                <ul>
                  <li><i class="fa fa-envelope"></i> Khaddar@gmail.ma</li>
                  <li>Free Shipping for all </li>
                </ul>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Sidi moussa , el jadida</li>
                <li>Phone: +212 636 44 59 96</li>
                <li>Email: khaddar@gmail.ma</li>
              </ul>
            </div>
          </div>
